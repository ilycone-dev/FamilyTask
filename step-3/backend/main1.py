                    ...
                    "messages": [
                        {
                            ...
                            "content": (
                                ...
                                "Utilise le prénom du membre pour la valeur personne. "
                                "Si plusieurs membres partagent le même lien, renvoie une question de clarification. "
                                "Si l'action est clairement une création de tâche, appelle le tool.")
                        },
    ...
    if tool_calls:
        for tool_call in tool_calls:
            ...
            if name == "ajouter_tache":
                ...
                return {"text": f"La tâche « {task.title} » a été créée pour {member.name}."}

    return {"text": assistant_text or ""}
